...
enum Orientation2 { ORIENTATION2_COLLINEAR, ORIENTATION2_CCW, ORIENTATION2_CW };
...
struct FadeException : public std::exception {
  virtual const char* what() const throw() {
    return "\n  FADE EXCEPTION due to a bug _or_ wrong usage of Fade. If you "
           "think it is a \n  bug then please report this incident and it will "
           "be fixed quickly: bkorn@geom.at";
  }
};

 ...
 *
 * \image html random_objects.png "Random objects (points, lines, polygons,
 * polylines)"
 *
 ...
 */
FUNC_DECLSPEC
void generateRandomNumbers(size_t num, double min, double max,
 ...
 */
FUNC_DECLSPEC
void generateRandomPoints(size_t numRandomPoints, double min, double max,
 ...
 */
FUNC_DECLSPEC
void generateRandomPoints3D(size_t numRandomPoints, double min, double max,
                            std::vector<Point2>& vRandomPointsOut,
                            unsigned int seed = 0);
 ...
 * \image latex randomPolygon.eps "Polygon generator: Random simple polygon"
 * width=10cm
 */
FUNC_DECLSPEC
void generateRandomPolygon(size_t numSegments, double min, double max,
 ...
 * \image latex randomSegments.eps "Segment generator: Random line segments"
 * width=10cm
 */
FUNC_DECLSPEC
void generateRandomSegments(size_t numSegments, double min, double max,
                            double maxLen, std::vector<Segment2>& vSegmentsOut,
                            unsigned int seed);
 ...
 *
 * * \image html sinePolyline.png "Polyline generator: Polylines from sine
 * functions" \image latex sinePolyline.eps "Polyline generator: Polylines from
 * sine functions" width=10cm
 */
FUNC_DECLSPEC
void generateSineSegments(int numSegments, int numPeriods, double xOffset,
                          double yOffset, double xFactor,
...
#if GEOM_PSEUDO3D == GEOM_TRUE
FUNC_DECLSPEC
void generateCircle(int numPoints, double x, double y, double z, double radiusX,
                    double radiusY, std::vector<Point2>& vCirclePointsOut);
#else
FUNC_DECLSPEC
void generateCircle(int numPoints, double x, double y, double radiusX,
                    double radiusY, std::vector<Point2>& vCirclePointsOut);
#endif
 ...
 *
 * @param numX,numY specifies the grid size and must be >1. numX*numY points are
 * created
 ...
 */
FUNC_DECLSPEC
void generateRandomSurfacePoints(size_t numX, size_t numY, size_t numCenters,
